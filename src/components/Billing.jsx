    ...
    <section id='product' className={layout.sectionReverse}>
        ...
        <div className={layout.sectionInfo}>
          ...
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. A eos eligendi labore velit quas sed. Pariatur voluptas tenetur a excepturi. Lorem ipsum dolor sit amet.
          </p>
